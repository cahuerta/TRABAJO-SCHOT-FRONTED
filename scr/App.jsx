...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '40px auto', fontFamily: 'system-ui, Arial' }}>
      ...
      <p><b>Backend:</b> {import.meta.env.VITE_BACKEND_BASE || '(no configurado)'}</p>

      <h2>Paciente (guarda en “Pacientes”)</h2>
